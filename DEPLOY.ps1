...
git add -A
git status --short
git commit -m "feat: rediseño dashboard (grafs arriba, tareas solo supervisor) + pipeline kanban compacto (columnas 178px, tarjetas compactas, terminales colapsadas)"
git branch -M main
