// Script de un solo uso: importa la hoja MOVIMIENTOS_DEAL (Sara) a HubSpot
...
//   cd bepharma-crm
//   node api/scripts/import-movimientos-notes-sara.js --dry-run
//     -> solo hace matching contra los Deals reales y cuenta, no crea nada
//   node api/scripts/import-movimientos-notes-sara.js --confirm
//     -> pide escribir "IMPORTAR NOTAS" y crea las notas de verdad
//
// Lee el token desde bepharma-crm/.env (HUBSPOT_ACCESS_TOKEN) y los
// movimientos desde api/scripts/data/movimientos_sara.json (ya incluido).
...
const DATA_FILE = process.argv.find(a => a.startsWith('--data='))
  ...
  : path.join(__dirname, 'data', 'movimientos_sara.json')

const DRY_RUN = !process.argv.includes('--confirm')
const BATCH_SIZE = 100
const REQUEST_DELAY_MS = 200

// Owner de Sara (ver mapa de owners en memoria del proyecto BePharma).
// Si este script se reusa para otro operador, cambiar este ID.
const OPERATOR_OWNER_ID = '73112880' // Sara
