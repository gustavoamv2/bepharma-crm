// Script de un solo uso: asocia los Contactos importados (Yesenia) con su
...
// 971 empresas de Yesenia (bp_zona = 'carlos') tienen 0 contactos asociados.
//
...
//   cd bepharma-crm
//   node api/scripts/fix-contact-company-associations-yesenia.js --dry-run
//   node api/scripts/fix-contact-company-associations-yesenia.js --confirm
//
// Lee el token desde bepharma-crm/.env (HUBSPOT_ACCESS_TOKEN) y el mapeo
// contacto->dominio desde api/scripts/data/contactos_empresa_map_yesenia.json
...
// empresas de Yesenia quedaron con la propiedad ESTANDAR "domain" vacia
...
// Y se filtra SOLO a empresas con bp_zona='yesenia'. Si dos empresas de
...
const DATA_FILE = process.argv.find(a => a.startsWith('--data='))
  ...
  : path.join(__dirname, 'data', 'contactos_empresa_map_yesenia.json')
