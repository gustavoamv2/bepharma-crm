// Script de un solo uso: importa la hoja MOVIMIENTOS_DEAL (Yesenia) a HubSpot
...
//   cd bepharma-crm
//   node api/scripts/import-movimientos-notes-yesenia.js --dry-run
//     -> solo hace matching contra los Deals reales y cuenta, no crea nada
//   node api/scripts/import-movimientos-notes-yesenia.js --confirm
//     -> pide escribir "IMPORTAR NOTAS" y crea las notas de verdad
//
// Lee el token desde bepharma-crm/.env (HUBSPOT_ACCESS_TOKEN) y los
// movimientos desde api/scripts/data/movimientos_yesenia.json (ya incluido).
...
const DATA_FILE = process.argv.find(a => a.startsWith('--data='))
  ...
  : path.join(__dirname, 'data', 'movimientos_yesenia.json')

const DRY_RUN = !process.argv.includes('--confirm')
const BATCH_SIZE = 100
const REQUEST_DELAY_MS = 200

// Owner de Yesenia (ver mapa de owners en memoria del proyecto BePharma).
// Si este script se reusa para otro operador, cambiar este ID.
const OPERATOR_OWNER_ID = '93621022' // Yesenia
