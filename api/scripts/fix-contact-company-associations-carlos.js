// Script de un solo uso: asocia los Contactos importados (Carlos) con su
...
// 971 empresas de Carlos (bp_zona = 'carlos') tienen 0 contactos asociados.
//
...
//   cd bepharma-crm
//   node api/scripts/fix-contact-company-associations-carlos.js --dry-run
//   node api/scripts/fix-contact-company-associations-carlos.js --confirm
//
// Lee el token desde bepharma-crm/.env (HUBSPOT_ACCESS_TOKEN) y el mapeo
// contacto->dominio desde api/scripts/data/contactos_empresa_map_carlos.json
...
// empresas de Carlos quedaron con la propiedad ESTANDAR "domain" vacia
...
// Y se filtra SOLO a empresas con bp_zona='carlos'. Si dos empresas de
...
const DATA_FILE = process.argv.find(a => a.startsWith('--data='))
  ...
  : path.join(__dirname, 'data', 'contactos_empresa_map_carlos.json')
