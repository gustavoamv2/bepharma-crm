...
SRC_DIR = "Yesenia"
OUT_XLSX = "BePharma_Excel_Importacion_Yesenia.xlsx"
OPERATOR_EMAIL = "yesenia@bepharma.org"
OPERATOR_ZONE = "yesenia"
OPERATOR_PREFIX = "BP-YES"
...
FILE_COUNTRY_FALLBACK = {
    "Argentina Septiembre 2026.xlsx": "Argentina",
    "Bolivia Septiembre 2026.xlsx": "Bolivia",
    "Chile Septiembre 2026.xlsx": "Chile",
    "Colombia Septiembre 2026.xlsx": "Colombia",
    "Costa Rica Septiembre 2026.xlsx": "Costa Rica",
    "Dominicana Septiembre 2026.xlsx": "Republica Dominicana",
    "Ecuador Septimbre 2026.xlsx": "Ecuador",
    "El Salvador Septiembre 2026.xlsx": "El Salvador",
    "Guatemala Septiembre 2026.xlsx": "Guatemala",
    "Honduras Septiembre 2026.xlsx": "Honduras",
    "Nicaragua Septiembre 2026.xlsx": "Nicaragua",
    "Panama Septiembre 2026.xlsx": "Panama",
    "Paraguay Septiembre 2026.xlsx": "Paraguay",
    "Peru Septiembre 2026.xlsx": "Peru",
    "Uruguay Septiembre 2026.xlsx": "Uruguay",
    "Venezuela Septiembre 2026.xlsx": "Venezuela",
    "Prospectos LinkedIn BePharma Yes.xlsx": "",  # multi-pais, se resuelve por fila
    # "Espaсa Septiembre 2026.xlsx" tiene el nombre de archivo mal codificado
    # (deberia decir "España"); no hace falta mapearlo porque su fila 1
    # ("Espana 2026") se lee bien via extract_country_from_row1().
}

STATE_TO_COUNTRY = {}

COUNTRY_REGION = {
    "argentina": "latam_sur", "bolivia": "latam_sur", "chile": "latam_sur",
    "ecuador": "latam_sur", "paraguay": "latam_sur", "peru": "latam_sur",
    "uruguay": "latam_sur",
    "colombia": "latam_norte", "costa rica": "latam_norte", "el salvador": "latam_norte",
    "guatemala": "latam_norte", "honduras": "latam_norte", "nicaragua": "latam_norte",
    "panama": "latam_norte", "venezuela": "latam_norte",
    "republica dominicana": "latam_caribe",
    "espana": "europa_occ",
}
...
def process_workbook(path, file_country_map, log):
    ...
    for sheet_name in wb.sheetnames:
        ...
        if not hasattr(ws, "cell"):
            # Hoja de tipo Chartsheet (grafico), no tiene celdas de datos --
            # se detecto en Dominicana Septiembre 2026.xlsx (hoja "Grafico1").
            log.append(("HOJA SIN HEADER RECONOCIBLE", fname, sheet_name, "Es una hoja de grafico, no de datos -- omitida"))
            continue
